...
function educate_framework_menu_settings() {
    $educate_menu = array(
        'page_title' => __('Theme Options', 'educate'),
        'menu_title' => __('Theme Options', 'educate'),
        ...
        <form method="post" action="options.php" id="form-option" class="theme_option_ft">
            <div class="themeoption-header">
                <div class="logo">
                    ...
                    echo "<a href='https://fasterthemes.com' target='_blank'><img src='" . esc_url($educate_image) . "' alt='" . __('FasterThemes', 'educate') . "'  /></a>";
                    ?>
                </div>
    ...
    <?php _e('RSS', 'educate'); ?>
                         ...
                         <div id="options-group-5" class="group theme-option-inner-tabs educate-pro-image">  
							<div class="educate-pro-header">
							  ...
							  <a href="https://fasterthemes.com/wordpress-themes/educate/" target="_blank">
